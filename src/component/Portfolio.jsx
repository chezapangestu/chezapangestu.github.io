...
function Portoflio(){
    return(
        ...
        {/* </div> */}
            {/* <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 grid-rows-2 gap-4 sm:gap-6 lg:gap-8"> */}
    ...
    <img src="https://tailwindui.com/img/ecommerce-images/product-feature-03-detail-03.jpg" alt="Side of walnut card tray with card groove and recessed card area." class="rounded-lg bg-gray-100" /> */}
        <div className="next-section sm:small-body md:medium-body lg:large-body dark:bg-dark-black dark:text-white">
            ...
            <h1 className="text-3xl font-bold mb-6">
                ...
                <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-fit lg:grid-cols-3 lg:gap-x-8 lg:px-6">
                <div class="aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block">
                    <img src="https://via.placeholder.com/150" alt="Two each of gray, white, and black shirts laying flat." class="h-full w-full object-cover object-center" />
                ...
                <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
                    ...
                    <img src="https://via.placeholder.com/150" alt="Model wearing plain black basic tee." class="h-full w-full object-cover object-center" />
                    ...
                    <div class="aspect-w-3 aspect-h-2 overflow-hidden rounded-lg">
                    <img src="https://via.placeholder.com/150" alt="Model wearing plain gray basic tee." class="h-full w-full object-cover object-center" />
                ...
                <div class="aspect-w-4 aspect-h-5 sm:overflow-hidden sm:rounded-lg lg:aspect-w-3 lg:aspect-h-4">
                    <img src="https://via.placeholder.com/150" alt="Model wearing plain white basic tee." class="rounded h-full w-full object-cover object-center" />
                    {/* <img src="https://tailwindui.com/img/ecommerce-images/product-page-02-featured-product-shot.jpg" alt="Model wearing plain white basic tee." class="rounded h-full w-full object-cover object-center" /> */}
                </div>
                </div> 

                {/* <img src="https://i.pinimg.com/originals/f8/e3/95/f8e395b6785428be9450d570bf48bf09.png" alt="Walnut card tray filled with cards and card angled in dedicated groove." class="object-fill h-100 w-500 rounded-lg bg-gray-100" /> */}
                <div class="mx-auto max-w-2xl pt-10 pb-16 sm:px-6 lg:grid lg:max-w-fit lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
                <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Website projects</h1>
                </div>
                ...
                <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pb-16 lg:pr-8">
                    ...
                    <div class="mt-4">
                        <div role="list" class="list-disc space-y-2 pl-4 text-sm">
