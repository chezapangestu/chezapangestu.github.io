...
function Portoflio(){
    ...
    return(
        <section id="portfolio">
            ...
            <p className="font-medium font-circular text-lg text-gray-500 dark:text-whity mt-3 mb-6">Read about some of the products and website I've got the opportunity to work on</p>
