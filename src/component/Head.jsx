                ...
                <div className="pt-20 sm:pt28 md:pt-28 lg:pt-28">
                    ...
                    <div className="border-l border-gray-200 dark:border-gray-700">
                        <li className="mt-6 mb-10 ml-6">            
                            ...
                            <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Web Developer Intern - Telkom Indonesia ITDRI<span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">Latest</span></h3>
                            ...
                            <div role="list" className="list-disc text-justify space-y-2 pl-4 mt-3 text-sm">
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Helping the SVCC 3-2 squad to achieve the best team among the 14 other SVCC squads by increasing the MERIT score from 73.56 to 87.14 in 1 sprint (2 weeks).</li>
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Created six initial designs of Instagram feeds, which had an average of 53 likes per post and 343 engagements, which exceeded the objective key result of 10 likes per post and 100 engagements.</li>  
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Help create golden circles, product concepts, and websites that allow squads to qualify for exclusive coaching three times in a row.</li>  
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Be able to emerge as the best squad at the checkpoint prototype website with a fully functional website deployed and hosted. The website that was built within three days completed the login, register, landing page, product order forms, and prototype page features which were divided into two products, namely virtual expos and webinars. Also, integrating chatbot crisp APIs and admin management pages (CMS) to manage product order form data.</li>  
                            </div>
                            <div className="mt-3">
                        ...
                        <li className="mb-10 ml-6">
                            ...
                            <p className="text-sm text-justify font-normal text-gray-500 dark:text-gray-400">Incorporated into the SMK Project at Al-Huda Sariwangi Vocational High School Tasikmalaya, Jawa Barat. The SMK project aims to increase the competitiveness and capability of SMK students so that they can see the digital talent potential of SMK students throughout Indonesia. Project SMK has 5 (five) main products, namely SmartEye VR, Sprinthink, Tomps, MyDigiLearn, and Ideabox. My area of responsibilities: </p>
                            <div role="list" className="list-disc text-justify space-y-2 pl-4 mt-3 text-sm">
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Teaching 20 people divided into two groups to solve wicked problems around vocational school children by solving the Sprintthink method. Successfully raised one of the main topics, namely the MyHair application, the search app for the nearest barbershop, to be developed and made into an actual project</li>
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Create a virtual tour using the SmartEye VR product method to show the situation and internal conditions of Al Huda Sariwangi Vocational High School that have never been covered anywhere.</li>  
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Teaching students to use computers in school labs with product materials from MyDigiLearn, namely learning applications with interactive videos that contain soft skills for work, Ideabox, which is used as an innovative social media to convey ideas and collaborate to develop them, and also TOMPS which is an application for mobile and web-based project management to be able to manage and monitor a project anywhere and anytime.</li>  
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Looking for digital talent and succeeded in donating four students in the group to become the best talent in VR Smarteye learning.</li>  
                            </div>
                            <div className="mt-3">
                        ...
                        <li className="ml-6">
                            ...
                            <div role="list" className="list-disc text-justify space-y-2 pl-4 text-sm">
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Analyzing the Heuristic Evaluation on the LinkAja application to look for negative findings, determine the severity rating scale, and make a final report in the form of a conclusion and recommendations. Managed to find four negative findings.</li>
                                <li className="mb-2 font-normal text-gray-500 dark:text-gray-400">Conducted usability testing with Surveymonkey and LookbackParticipate tools on five users who were previously new and had used the LinkAja application intending to see how the user's experience was in using the LinkAja application.</li>  
                            </div>
                            <div className="mt-3">
                    ...
                    <div className=" border-l border-gray-200 dark:border-gray-700">
                        <li className="mt-6 mb-10 ml-6">            
                            ...
                            <div role="list" className="list-disc text-justify space-y-2 pl-4 text-sm ">
                                <li className="font-normal text-gray-500 dark:text-gray-400">Recording minutes and documenting activities are covering 11 divisions.</li>
                                <li className="font-normal text-gray-500 dark:text-gray-400">Be in charge of the secretary regarding external affairs such as relations and establish cooperation with other external groups.</li>  
                                <li className="font-normal text-gray-500 dark:text-gray-400">Creating a complete database along with student personal information for 128 staff.</li>  
                                <li className="font-normal text-gray-500 dark:text-gray-400">Managed to organize 77 incoming and 83 outgoing letters during one complete management.</li>  
                                <li className="font-normal text-gray-500 dark:text-gray-400">Designing association logos, booklets, and Instagram feeds for association cabinet campaigns.</li>  
                                <li className="font-normal text-gray-500 dark:text-gray-400">Created 252 PPT slides which included a recapitulation of the performance results of 11 divisions and calculated the achievement of the realization of success parameters in percentage form.</li>  
                            </div>
                        ...
                        <li className="mb-10 ml-6">
                            ...
                            <div role="list" className="list-disc text-justify space-y-2 pl-4 text-sm">
                                <li className="font-normal text-gray-500 dark:text-gray-400">Making posters for a competition attended by more than 100+ students from all over universities in Indonesia.</li>
                                <li className="font-normal text-gray-500 dark:text-gray-400">Create assets consisting of icons on the competition website with the theme of competitive programming and capture the flag, favicon, statue with isometric designs, and twibbon, as well as the cover rules book of the competition to be used by all contest participants.</li>  
                                <li className="font-normal text-gray-500 dark:text-gray-400">Assisted in the publication and documentation of the first year's national Competitive programming and Captured the Flag competitions at Telkom University in conducting national-level programming competitions.</li>  
                            </div>
                            <div className="mt-3">
                                <span className="bg-blue-200 text-blue-900 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">AdobePhotoshop</span>
                                <span className="bg-yellow-200 text-yellow-900 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">AdobeIlustrator</span>
                        ...
                        <li className="ml-6">
                            ...
                            <div role="list" className="list-disc text-justify space-y-2 pl-4 text-sm">
                                <li className="font-normal text-gray-500 dark:text-gray-400">Being in charge of the Open house, a big event introducing associations, laboratories, and community entities in the Informatics major to new students which 350+ new students successfully attended.</li>
                                <li className="font-normal text-gray-500 dark:text-gray-400">Be in charge of Seputar-IF which is information related to the world of informatics presented in the form of feeds and video posts on the Instagram platform which has managed to have an average of 110 likes and 1100+ viewers.</li>  
                                <li className="font-normal text-gray-500 dark:text-gray-400">Created a donation poster design for HIMA IF Cares Against Covid 19 which managed to raise funds of Rp. 10.151.173.</li>  
                                <li className="font-normal text-gray-500 dark:text-gray-400">Became the secretary of the MIK division who succeeded in documenting and recapitulating each division's internal plenary meeting online during a pandemic.</li>  
                                <li className="font-normal text-gray-500 dark:text-gray-400">Successfully made 187 designs in 1 year of management consisting of posters, certificates, Instagram feeds/stories, OA Lines, Youtube thumbnails, ppt slides.</li>  
                            </div>
                            <div className="mt-3">
                                <span className="bg-blue-200 text-blue-900 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">AdobePhotoshop</span>
